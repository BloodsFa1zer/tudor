...
func emailSenderFunc(redirectURL, fromName, fromEmail, fromPassword string) func(token, to string) error {
	return func(token, toEmail string) error {
		msg := gomail.NewMessage()
		msg.SetHeader("From", fmt.Sprintf("%s <%s>", fromName, fromEmail))
		msg.SetHeader("To", toEmail)
		msg.SetHeader("Subject", "Password reset")
		msg.SetBody("text/html", newEmail(redirectURL, toEmail, token))

		postman := gomail.NewDialer("smtp.gmail.com", 587, fromEmail, fromPassword)
